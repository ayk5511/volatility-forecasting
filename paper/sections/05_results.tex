...
\begin{table}[H]
\centering
\caption{Top 10 features by LightGBM split-importance (single fit on 2004--2021 train+validation window, $n_{\text{boost}} = 80$). Share is split count divided by total split count across all 30 features.}

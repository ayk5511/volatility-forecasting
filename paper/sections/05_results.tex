...
This inversion is the central nuanced finding of the paper. Tree-based ML models, despite their richer feature set, struggle in 2022 because the 2022 environment is structurally different from anything in their pre-2022 training data. The leverage-effect features they rely on are out-of-distribution. Parametric GARCH models, with their fewer degrees of freedom and direct conditional-variance recursion, are more robust to this regime shift. In 2023--2025, when the volatility level normalizes and intra-year regimes are more like the training data, the larger feature panel pays off and tree models recover.

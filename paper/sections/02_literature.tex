...
Volatility forecasting has a deep literature, and we do not attempt to survey it comprehensively---\citet{Poon2003} and \citet{Andersen2006} provide book-length treatments. Instead, we focus on the developments most relevant to our comparison: the GARCH family, realized volatility models, and the ML approaches that have emerged since roughly 2015.
...
A robust finding across the forecasting literature---not just in finance---is that combining forecasts from multiple models typically outperforms any individual model \citep{Timmermann2006}. For volatility specifically, \citet{Patton2019} show that simple equal-weight combinations of volatility forecasts are competitive with sophisticated combination schemes based on past performance. This motivates our inclusion of a simple ensemble as a benchmark.
